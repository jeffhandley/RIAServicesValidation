namespace RudeValidation.LoginUI
{
    using System;
    ...
    public partial class RegistrationForm : StackPanel
    {
        ...
        private void RegisterForm_AutoGeneratingField(object dataForm, DataFormAutoGeneratingFieldEventArgs e)
        {
            ...
            else if (e.PropertyName == "Question")
            {
                ...
                e.Field.ReplaceContent(comboBoxWithSecurityQuestions, ComboBox.SelectedItemProperty, binding => binding.Converter = new TargetNullValueConverter(), TextBox.TextProperty);
            }
        }
